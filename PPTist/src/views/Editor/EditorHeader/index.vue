<template>
  <div class="editor-header">
    <div class="left">
      <a class="menu-item back-home" v-if="lingxiProject" :href="backHomeHref" @click="handleBackHomeClick">
...
const lingxiParams = new URLSearchParams(window.location.search)
const lingxiProject = lingxiParams.get('project') || ''
const lingxiToken = lingxiParams.get('auth_token') || localStorage.getItem('lingxi-auth-token') || ''
const backHomeParams = new URLSearchParams()
if (lingxiProject) backHomeParams.set('project', lingxiProject)
if (lingxiToken) backHomeParams.set('auth_token', lingxiToken)
const backHomeHref = backHomeParams.toString() ? `/?${backHomeParams.toString()}` : '/'
