...
export default {
  ...
  getLingxiProject(projectName: string): Promise<any> {
    return axios.get(`/api/projects/${encodeURIComponent(projectName)}/pptist`)
  },

  saveLingxiProject(projectName: string, payload: Record<string, any>): Promise<any> {
    return axios.post(`/api/projects/${encodeURIComponent(projectName)}/pptist`, payload)
  },
